                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Center(
                                      child: Text(
                                        AppLocalizations.of(context)!.commonWelcome,
                                        style: TextStyle(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Input(
                                          placeholder: AppLocalizations.of(context)!.commonPassword,
                                      ...
                                      Padding(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Text(
                                            AppLocalizations.of(context)!.commonForgotPassword,
                                            style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Center(
                                      child: Text(
                                        AppLocalizations.of(context)!.commonQuote,
