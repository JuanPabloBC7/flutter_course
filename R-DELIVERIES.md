...
## Sprint Delivery Videos
Here you will find the list of deliveries, sprint by sprint.
Frontend: [flutter_course - transversal_project (branch)](https://github.com/JuanPabloBC7/flutter_course/tree/feature/transversal_project)
Backend: [flutter_course_backend - main (branch)](https://github.com/JuanPabloBC7/flutter_course_backend.git)

### Sprint 1 - HU 1 Advance Flutter and Dart Fundamentals
- [Video](https://drive.google.com/file/d/1YatGbW-SEUROhhDvGQt40QAryPF_YNx2/view?usp=drive_link)

### Sprint 2 - HU 2 Clean Architecture and State Management
- [Video](https://drive.google.com/file/d/1YatGbW-SEUROhhDvGQt40QAryPF_YNx2/view?usp=drive_link)
...
### Sprint 7 – IA and Software Quality
- Video
